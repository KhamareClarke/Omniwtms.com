  ...
  try {
    ...
    if (!supabaseUrl || !supabaseServiceKey) {
      return NextResponse.json({
        success: false,
        message:
          "Storage bucket setup skipped. Add SUPABASE_SERVICE_ROLE_KEY to .env to enable image uploads.",
    ...
    if (createError) {
      ...
      return NextResponse.json({
        success: false,
        message:
          'Could not create storage bucket. Create "warehouse-assets" in Supabase Dashboard > Storage if needed.',
